...
<div class="main">
  <h1>Search Result</h1>
  <%
    ArrayList<String> listNames = (ArrayList<String>) request.getAttribute("searchResultNames");
    ArrayList<ArrayList<String>> listContents = (ArrayList<ArrayList<String>>) request.getAttribute("searchListContents");
    if (listNames.size() == 0) {
      %>
      <p>Nothing Found</p>
  <%  } else {
